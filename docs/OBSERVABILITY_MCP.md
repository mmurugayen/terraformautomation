...
The synchronized reader and 25-test MCP module come from the combined [canonical Platform review #47](https://github.com/mmurugayen/gysam-platform/pull/47); source commit `c2aade3bd28bd2d168763731cda21354b89ecb1f` preserves the reviewed reader bytes. Consumers require that canonical merge and their own candidate CI. [Reader validation](validation/bounded-reader-2026-09-17.json) records baseline failures, exact source hashes and the composed suite.
